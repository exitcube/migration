...
export class UpdatedMigration1764661309092 implements MigrationInterface {
    name = 'UpdatedMigration1764661309092'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bannerCategory" ("id" SERIAL NOT NULL, "dsiplayText" text, "value" character varying, "createdBy" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT false, "approvedBy" integer, CONSTRAINT "PK_f4b8b099ce9b09229fa98cc2c87" PRIMARY KEY ("id"))`);
